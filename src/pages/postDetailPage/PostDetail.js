...
const Post = () => {
  ...
  return (
    <div className="container postDetail__container">
      <div className="postDetail__title">{sampleData.title}</div>
      <div className="postDetail__detail">
        <div className="postDetail__information">
          <div className="postDetail__writer">
            <img
              className="postDetail__writerImg"
              src={sampleData.writer.img}
            />
            <div className="postDetail__writerName">
              {sampleData.writer.name}
            </div>
          </div>
          <div className="postDetail__detail--separator">·</div>
          <div className="postDetail__date">{sampleData.date}</div>
        </div>
        <div className="postDetail__buttonBar">
          <div className="button postDetail__button">수정</div>
